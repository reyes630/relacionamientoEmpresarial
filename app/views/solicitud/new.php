...
<body>
    ...
    <img src="/img/logoSenaVerde.png" alt="SENA" class="logo">        
        <h2 class="title">Bienvenido al Servicio Nacional de Aprendizaje</h2>
            <p>Usted está a punto de realizar una solicitud de servicio</p>
